...
Tops=Frame(window,width=1350,height=50,bd=8,bg="pink")
Tops.pack()
#---------------------------------------------------------------------
#------------------
...
flb=Frame(f1,width=300,height=600,bd=8,bg="orange")
flb.pack(side=TOP)
#---------------------------------------------------------------------

lblinfo=Label(Tops,font=('arial',30,'bold'),text="Employee Payroll",bd=10,fg="green")
...
#=============================== buttons ===============================================================
btnsalary=Button(flb,text='Weekly Salary',padx=10,pady=10,bd=8,font=('arial',7,'bold'),width=6,fg="red",bg="powder blue",command=weeklywages).grid(row=0,column=0)
...
btnpayslip=Button(flb,text='View Payslip',padx=10,pady=10,bd=8,font=('arial',7,'bold'),width=6,command=
enterinfo,fg="red",bg="powder blue").grid(row=0,column=2)
btnexit=Button(flb,text='Exit System',padx=10,pady=10,bd=8,font=('arial',7,'bold'),width=6,command=exit,fg="red",bg="powder blue").grid(row=0,column=3)
